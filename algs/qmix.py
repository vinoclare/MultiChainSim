...
class QMix:
    ...
    def train(self, batch):
        ...
        q_total, _ = self.model(task_obs, load_obs, profile_obs, state)  # Q_tot(s, a)
        with torch.no_grad():
            target_q_total, _ = self.target_model(next_task_obs, next_load_obs, next_profile_obs, next_state)
