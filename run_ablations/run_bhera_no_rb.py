...
from algs.bhera_no_rb import BHERA
...
parser.add_argument("--no_regime_balance", action="store_true", help="Ablation: disable regime-balanced weighting and entropy modulation")
...
def _init_worker(
    ...
    g_alg = BHERA(
        ...
        use_regime_balance=(not bool(no_regime_balance)),
        writer=None,
        global_step_ref=[0],
...
def main():
    ...
    alg = BHERA(
        ...
        use_regime_balance=(not bool(args.no_regime_balance)),
        writer=writer,
        global_step_ref=[0],
...
if __name__ == "__main__":
    log_dir = f"../logs/ablations/no_rb/{dire}/" + time.strftime("%Y%m%d-%H%M%S")
